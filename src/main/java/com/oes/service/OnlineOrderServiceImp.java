...
public class OnlineOrderServiceImp implements OnlineOrderService{
	...
	@Override
	public List<OnlineOrder> getOnlineOrderbyOrderDate(String orderDate)throws Exception{
		return ((OnlineOrderServiceImp) orderRepository).getOnlineOrderbyOrderDate(orderDate);
	}
